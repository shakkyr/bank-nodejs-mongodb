  ...
  const addNewCostumer = async () => {
    try {
      ...
      alertMessage.innerHTML =
        "<span style='color:red'>Account number already exist!!!</span>";
    }
  };
  return (
    <div className="add__user">
      ...
      <div>
        <input type="button" onClick={addNewCostumer} value="add" />
      </div>
